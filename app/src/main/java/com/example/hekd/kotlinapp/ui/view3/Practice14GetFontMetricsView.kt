...
class Practice14GetFontMetricsView : View {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawText(texts[0], 100f, middle.toFloat()+yOffset, paint2)
        canvas.drawText(texts[1], 200f, middle.toFloat()+yOffset, paint2)
        canvas.drawText(texts[2], 300f, middle.toFloat()+yOffset, paint2)
        canvas.drawText(texts[3], 400f, middle.toFloat()+yOffset, paint2)
        canvas.drawText(texts[4], 500f, middle.toFloat()+yOffset, paint2)
        canvas.drawText(texts[5], 600f, middle.toFloat()+yOffset, paint2)
    }
}
